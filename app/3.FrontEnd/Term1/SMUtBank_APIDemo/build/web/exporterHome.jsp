...
<body class="">
                                            ...
                                            <ul class="nav lt">
                                                <li>
                                                    <a href="#">
                                                        ...
                                                        <span>Approve LC</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="exporterViewLcLog.jsp">
                                                        <i class="fa fa-angle-right"></i>
                    ...
                    <section class="vbox">
                        <section class="scrollable">
                            <div class="wrapper-lg">
                                ...
                                <h4 class="text-primary font-bold">Exporter</h4>
                            </div>

                            <!--LC Table-->
                            <section class="panel panel-default">
                                <header class="panel-heading wrapper-lg">
                                    <h4 class="font-bold">LC to be approved</h4>
                                </header>
                                    ...
                                    <table class="table table-striped b-t b-light" id="lcTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Nov 2, 2017</td>
                                                <td>
                                                    <a href="approveLc.html" class="active btn btn-s-md btn-primary">View LC</a>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <footer class="panel-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-center">
                                            <a href="viewLcLog.html" class="btn btn-s-md btn-dark">View LC History</a>
                                        </div>
    ...
    <script src="jassets/s/calendar/bootstrap_calendar.js"></script>
