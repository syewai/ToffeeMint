                        ...
                        if (xmlHttp.readyState === 4 && xmlHttp.status === 200) {
                            ...
                            if (true){
                                ...
                                for (i = 0; i < 5; i++) {
                                    ...
                                    //localhost:9001/lc/getContract?refNum=
                                            
                                    //get adv bank as 2nd col
                                    //get date submitted as 3rd col
                                    //get status as 4th col
                                    
                                    //call another function to display coresponding operations based on status
                                    // E.g. modify lc will be displayed only when status = "Requested to amend"
                                ...
                                $('#button1').click(function(e) {  
                                    ...
                                    window.location.replace("/SMUtBank_TradeFinance/importer/lcDetails.html?refNum="
                                        +refNumList[0]
                                        );
...
function buttonAssigned() { 
    //this function is to map the button and operation to coresponding status
    var operationMatches = {"submitted": "view lc", "issued": "view lc", "rejected": "request to amend", };  
